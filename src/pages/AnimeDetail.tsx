...
const AnimeDetail = () => {
	...
	const { selectedAnime, characters, loading } = useAppSelector(
		(state) => state.anime
	);
	...
	return (
		<div className="min-h-screen bg-background">
			...
			<div className="relative h-full overflow-hidden py-3">
				...
				<div className="relative container mx-auto px-4 max-md:p-2 h-full flex flex-col items-start pb-8">
					<Link to="/">
					...
					<div className="flex flex-col md:flex-row gap-8 max-md:gap-3 w-full">
						<img
